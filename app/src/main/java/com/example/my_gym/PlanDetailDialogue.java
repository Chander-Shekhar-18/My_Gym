...
public class PlanDetailDialogue extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View view =getActivity().getLayoutInflater().inflate(R.layout.dialogue_plan_details,null);
        initViews(view);
        Context context;
    ...
    private void initViews(View view) {
        ...
        btnDismiss=view.findViewById(R.id.btnDismis);
        txtName=view.findViewById(R.id.txtName69);
